...
if (defined $number_to_guess and defined $guess) {
    ...
    if ($guess == $number_to_guess) {
        ...
        print "<div class=\"guess_details\">Its higher than $guess.\n</div>";
    } else {
        print "<div class=\"guess_details\">Its lower than $guess.\n</div>";
    }
} else {
    $number_to_guess = 1 + int(rand $max_number_to_guess);
    print "<div class=\"guess_heading\">\nI've thought of number 0..$max_number_to_guess\n</div>";
}
